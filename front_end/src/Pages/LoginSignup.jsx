...
const LoginSignup = () => {
   ...
   const login = async () =>{
      ...
      let responseData;
      await fetch('https://ecommerce-node-app-3e9f24b61b07.herokuapp.com/login',{
         method:'POST',
         headers:{
   ...
   const signup = async () =>{
      ...
      let responseData;
      await fetch('https://ecommerce-node-app-3e9f24b61b07.herokuapp.com/signup',{
         method:'POST',
         headers:{
            Accept:'application/form-data',
            'Content-Type':'application/json',
   ...
   return (
      <div className="loginsignup">
         <div className="loginsignup-container">
            ...
            <p className="loginsignup-login">To create a new account <span onClick={()=>{setState("Sign Up")}}>click here.</span></p>
            }
